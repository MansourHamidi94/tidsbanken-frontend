...
function ControlPanel() {
  ...
  const monthShorted =
    currentMonthName.charAt(0).toUpperCase() + currentMonthName.substring(1, 3);
    ...
    <div className="container-for-site">
      ...
      <div className="row justify-content-center mb-5 control-panel-container">
        <div className="col-md-3 mb-3">
          <Link
            to="/Calendar"
            className="card control-panel-card bg-light shadow-lg mb-3 text-decoration-none"
          >
          ...
          <Link
            to="/vacation-request"
            className="card control-panel-card bg-light shadow-lg text-decoration-none"
          >
            <div className="control-panel-card__body text-center">
