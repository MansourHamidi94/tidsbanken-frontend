...
function VacationPlanner({
  ...
  const handleSendRequest = () => {
    ...
    setPopupMessage(
      `Vacation request sent with start date: ${reduxStartDate.toLocaleDateString()} and end date: ${reduxEndDate.toLocaleDateString()}`
    );
  };
            ...
            <>
              ...
              <button
                ...
                onClick={() => {
                  handleSendRequest();
                  setPopupMessage(
                    `Vacation sent with start date: ${startDate.toLocaleDateString()} and end date: ${endDate.toLocaleDateString()}`
                  );
                }}
                id="send-button"
              >
